...
ასევე შესაძლებელია პროგრამის დაარქივებულ ფაილად გადმოწერა. ამისათვის, რეპოზიტორის ზედა მარჯვენა კუთხეში უნდა დააწკაპოთ მწვანე ღილაკს [**Code**]{style="color:green"} და გამოჩენილ მენიუში დააწყაპოთ **Download ZIP**.
